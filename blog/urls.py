...
urlpatterns = [
    ...
    path('search/<str:key_string>/', views.PostSearchListView.as_view(), name='post-search-list'),
    path('from-author/<int:author_pk>/', views.PostFromAuthorListView.as_view(), name="posts-from-author"),
